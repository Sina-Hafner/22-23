...
# enter your code here ...
z <- data.frame(Land=c("Brasilien","Deutschland","Frankreich","Mexiko","Suedkorea"),Kontinent=c("Am","Eur","Eur","Am","As"),Jahr=c(2018),BIP=c(2.14, 4.21,2.93,1.21,1.69),ID=c(1,2,3,4,5))
...
# enter your code here ...
dat <- read.csv("data/eu_macro_2017.csv", header =TRUE, dec = ".", sep = ",")
...
# enter your code here ...
dat$gdp_share <- dat$gdp / sum(dat$gdp) 
