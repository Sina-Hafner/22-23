...
eu_makro <- read_csv("C:/Users/hafne/Documents/GitHub/22-23/problem-sets/ps4/data/EU_Makro.csv")
```
...
#intercept ist der Y-Achsenabschnitt, slope die Steigung
g2
```
Hier waere ein guter Zeitpunkt das Addin 'Check Problemset' auszufuehren!
...
#Die Standardabweichung der erklärenden Variable gibt an, wie stark die Werte der erklärenden Variable um ihren Mittelwert streuen.
#Der Standardfehler des Koeffizienten in einer linearen Regression gibt hingegen an, wie genau der geschätzte Koeffizient den tatsächlichen #Koeffizienten in der Population schätzt. 
```
Hier waere ein guter Zeitpunkt das Addin 'Check Problemset' auszufuehren!
